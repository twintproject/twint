...
def Tweet(config, t):
    if config.Format:
        ...
        output = output.replace("{username}", str(t.username))
        ...
        output = output.replace("{tweet}", str(t.tweet))
        ...
        output = output.replace("{near}", str(t.near))
        output = output.replace("{geo}", str(t.geo))
        output = output.replace("{mentions}", ",".join(str(t.mentions)))
        output = output.replace("{translate}", str(t.translate))
        output = output.replace("{trans_src}", str(t.trans_src))
        output = output.replace("{trans_dest}", str(t.trans_dest))
    else:
        ...
        if config.Show_hashtags:
            hashtags = ",".join(str(t.hashtags))
            output += f" {hashtags}"
        if config.Show_cashtags:
            cashtags = ",".join(str(t.cashtags))
            output += f" {cashtags}"
        if config.Stats:
