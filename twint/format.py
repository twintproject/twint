...
def Tweet(config, t):
    if config.Format:
        ...
        output = output.replace("{hashtags}", ",".join(map(str, t.hashtags)))
        output = output.replace("{cashtags}", ",".join(map(str, t.cashtags)))
        ...
        output = output.replace("{mentions}", ",".join(map(str, t.mentions)))
